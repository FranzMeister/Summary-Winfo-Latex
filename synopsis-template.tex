...
\begin{itemize}
	...
	\item [] \textbf{4. Phasee:} Informationsbereitstellung (90er Jahre)
\end{itemize}
\hrulefill
...
\subsection*{Lernziele}
\begin{enumerate}
	\item Sie kennen die Notwendigkeit der Verwendung von Modellen sowie verschiedene Arten von Modellen
	\item Sie verstehen den Unterschied zwischen Modell und Referenzmodell (Referenzbehauptung, Vor- und Nachteile)
	\item Sie haben einen Überblick über verschiedene Referenzmodelle (Handel, Industrie, Lieferketten)
\end{enumerate}
